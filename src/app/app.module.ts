...
import { 
            AFService, ChatService, FollowerService, GitService, 
            HttpService, PostService, ProjectService, UserService 
...
@NgModule({
    ...
    providers: [ 
                    AFService, ChatService, FollowerService, HttpService, 
                    GitService, ProjectService, PostService, UserService, 
                    UserStore 
                ],
